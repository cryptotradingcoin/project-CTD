...
RESOURCES += src/qt/ctdcoin.qrc src/qt/ctdcoin_locale.qrc

TRANSLATIONS += src/qt/locale/ctdcoin_bg.ts \
                src/qt/locale/ctdcoin_ca.ts \
                src/qt/locale/ctdcoin_cs.ts \
                src/qt/locale/ctdcoin_da.ts \
                src/qt/locale/ctdcoin_de.ts \
                src/qt/locale/ctdcoin_en.ts \
                src/qt/locale/ctdcoin_en_US.ts \
                src/qt/locale/ctdcoin_eo.ts \
                src/qt/locale/ctdcoin_es.ts \
                src/qt/locale/ctdcoin_es_ES.ts \
                src/qt/locale/ctdcoin_fi.ts \
                src/qt/locale/ctdcoin_fr.ts \
                src/qt/locale/ctdcoin_fr_FR.ts \
                src/qt/locale/ctdcoin_hi_IN.ts \
                src/qt/locale/ctdcoin_hr.ts \
                src/qt/locale/ctdcoin_hr_HR.ts \
                src/qt/locale/ctdcoin_it.ts \
                src/qt/locale/ctdcoin_ja.ts \
                src/qt/locale/ctdcoin_pl.ts \
                src/qt/locale/ctdcoin_ko_KR.ts \
                src/qt/locale/ctdcoin_lt_LT.ts \
                src/qt/locale/ctdcoin_nl.ts \
                src/qt/locale/ctdcoin_pl.ts \
                src/qt/locale/ctdcoin_pt.ts \
                src/qt/locale/ctdcoin_pt_BR.ts \
                src/qt/locale/ctdcoin_ro_RO.ts \
                src/qt/locale/ctdcoin_ru.ts \
                src/qt/locale/ctdcoin_sk.ts \
                src/qt/locale/ctdcoin_sv.ts \
                src/qt/locale/ctdcoin_tr.ts \
                src/qt/locale/ctdcoin_uk.ts \
                src/qt/locale/ctdcoin_vi.ts \
                src/qt/locale/ctdcoin_zh_CN.ts \
                src/qt/locale/ctdcoin_zh_TW.ts