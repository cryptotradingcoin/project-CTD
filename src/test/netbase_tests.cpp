...
// Copyright (c) 2015-2017 The PIVX and PIVX Core Developers
...
BOOST_AUTO_TEST_CASE(netbase_splithost)
{
    ...
    BOOST_CHECK(TestSplitHost("127.0.0.1:33263", "127.0.0.1", 33263));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:33263", "127.0.0.1", 33263));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:33263", "::ffff:127.0.0.1", 33263));
    BOOST_CHECK(TestSplitHost("[::]:33263", "::", 33263));
    BOOST_CHECK(TestSplitHost("::33263", "::33263", -1));
    BOOST_CHECK(TestSplitHost(":33263", "", 33263));
    BOOST_CHECK(TestSplitHost("[]:33263", "", 33263));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:33263", "127.0.0.1:33263"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:33263", "[::]:33263"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
