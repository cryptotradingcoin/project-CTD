...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("CTD Core ctdcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  ctdcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded ctdcoin transaction") + "\n" +
                               "  ctdcoin-tx [options] -create [commands]   " + _("Create hex-encoded ctdcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded ctdcoin transaction
