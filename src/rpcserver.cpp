...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* CTD features */
        {"ctdcoin", "masternode", &masternode, true, true, false},
        {"ctdcoin", "masternodelist", &masternodelist, true, true, false},
        {"ctdcoin", "mnbudget", &mnbudget, true, true, false},
        {"ctdcoin", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"ctdcoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"ctdcoin", "mnsync", &mnsync, true, true, false},
        {"ctdcoin", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use ctdcoind, or the -server option to ctdcoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> ctdcoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:33267/\n";
}
