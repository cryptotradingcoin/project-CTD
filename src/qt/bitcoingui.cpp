                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Ctd-Coin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a CTD address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and ctdcoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About CTD Core"), this);
    aboutAction->setStatusTip(tr("Show information about CTD Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for CTD"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your CTD addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified CTD addresses"));
    ...
    openAction->setStatusTip(tr("Open a CTD: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the CTD Core help message to get a list with possible CTD command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("CTD Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to CTD network", "", count));
}
...
{
    QString strTitle = tr("CTD Core"); // default title
