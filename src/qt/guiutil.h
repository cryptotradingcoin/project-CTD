...
/** Utility functions used by the CTD Qt UI.
 */
namespace GUIUtil
{
...
// Render CTD addresses in monospace font
...
// Parse "ctdcoin:" URI into recipient object, return true on successful parsing
