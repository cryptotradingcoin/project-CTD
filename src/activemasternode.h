...
// Copyright (c) 2015-2016 The Ctdcoin developers
...
private:
    ...
    /// Get 10000 CTD input that can be used for the Masternode
...
{
public:
    /// Is the inputs associated with this public key? (and there is 10000 CTD - checking if valid masternode)
